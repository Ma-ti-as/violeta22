...
while(num<50)
if(contador<2){
    alert(`Has fet servir ${contador} intent per de escriure un número igual o superior a 50`) /* Singular */
}
else(alert(`Has fet servir ${contador} intents per de escriure un número igual o superior a 50`)); /* Plural */